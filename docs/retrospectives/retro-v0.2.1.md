...
| 2026-01-13 | pm-arkraft#8394348 | False claims in documentation - Writing "automated" when actually manual creates technical debt and stakeholder confusion | pending |
...
- **2026-01-13**: ADR structure provides complete decision context. ADR-0001 (Confluence SSOT) and ADR-0002 (no tenant) demonstrate good practice of documenting "why not" decisions.
- **2026-01-13**: PM workflow aligned to philosophy principles makes abstract principles concrete for non-technical domain.
...
- **2026-01-13**: ROI analysis as decision guardrails (pm-arkraft ADR-0003) - Explicit Phase 2 entry conditions (7+ people, external reporting, 2+ weekly uses) and abandonment triggers (3-week no-use, stakeholders use Jira) prevent both premature optimization and sunk cost fallacy. Truth axiom applied to project value assessment.
- **2026-01-13**: Dual SSOT disambiguation pattern - When "SSOT" term has multiple valid meanings (Git as change source, Confluence as stakeholder view), explicit role labels (Working SSOT vs Stakeholder View) prevent conceptual confusion. One-way data flow diagram reinforces relationship.
- **2026-01-13**: Honesty in automation status - Correcting false automation claims to manual status demonstrates Truth axiom application. False claims create expectation debt. Reality alignment in docs prevents stakeholder confusion.
- **2026-01-13**: Phase-based roadmap with entry conditions - pm-arkraft's Phase 1/2/3 structure with measurable triggers (team size, frequency) implements Incremental principle. Clear thresholds prevent premature automation investment.
